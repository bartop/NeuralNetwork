...
//{
//    SigmoidNeuron output{0, 10};
//    SigmoidNeuron neuron[2]{{0, 10}, {0, 10}};
//    InputNeuron input[2];
//    InputNeuron bias(1.0);
...
//    {
//        NeuralNetwork<SigmoidNeuron, 2> neuralNetwork({2, 1, 3}, SigmoidNeuron());
//        neuralNetwork.calculateOutput();
//        CHECK(3 == neuralNetwork.getOutput().size());
//    }

//    SECTION("Test to JSON")
//    {
//        NeuralNetwork<SigmoidNeuron, 2> neuralNetwork({2, 1, 3}, SigmoidNeuron());
//        auto json = neuralNetwork.toJson();
//        INFO(json.dump());
//        CHECK(true == false);
//    }
...
//    SECTION( "learning XOR gate")
//    {
//        NeuralNetwork<SigmoidNeuron, 2> neuralNetwork({2, 10, 1}, SigmoidNeuron());
...
//        NeuralNetwork<SigmoidNeuron, 2> network({1, 100, 1}, SigmoidNeuron());
//        LearningAlgorithm learningAlgorithm(network);
//        network.getOutputNormalizer().setMax({5.0});
...
////        NeuralNetwork<SigmoidNeuron, 2> network({data.first.front().size(), 1000, data.second.front().size()}, SigmoidNeuron());
////        LearningAlgorithm learningAlgorithm(network);
